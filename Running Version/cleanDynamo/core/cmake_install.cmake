# Install script for directory: /home/james/Uni/summer11/code/Running Version/cleanDynamo/core
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib32/release" TYPE SHARED_LIBRARY FILES
    "/home/james/Uni/summer11/code/Running Version/cleanDynamo/lib/libdynamorio.so.2.0"
    "/home/james/Uni/summer11/code/Running Version/cleanDynamo/lib/libdynamorio.so"
    )
  FOREACH(file
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib32/release/libdynamorio.so.2.0"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib32/release/libdynamorio.so"
    ...
    IF(EXISTS "${file}" AND
      ...
      IF(CMAKE_INSTALL_DO_STRIP)
        EXECUTE_PROCESS(COMMAND "/home/bartons7/CodeSourcery/Sourcery_G++_Lite/arm-none-linux-gnueabi/bin/strip" "${file}")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib32/release/libdrpreload.so" AND
    ...
    FILE(RPATH_CHECK
         ...
         RPATH "")
  ENDIF()
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib32/release" TYPE SHARED_LIBRARY FILES "/home/james/Uni/summer11/code/Running Version/cleanDynamo/lib/libdrpreload.so")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib32/release/libdrpreload.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib32/release/libdrpreload.so")
    IF(CMAKE_INSTALL_DO_STRIP)
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib32/release" TYPE FILE FILES
    "/home/james/Uni/summer11/code/Running Version/cleanDynamo/lib/libdynamorio.so.1.4"
    "/home/james/Uni/summer11/code/Running Version/cleanDynamo/lib/libdynamorio.so.1.5"
    )
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
